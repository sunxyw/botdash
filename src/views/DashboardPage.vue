...
export default {
  ...
  mounted() {
    this.$http
      .get("http://127.0.0.1:4523/m1/1379808-0-default/clients")
      .then((response) => {
        console.log(response);
        this.clientsCount = response.data.data.clients.length;
      });
  },
  computed: {
    stats() {
